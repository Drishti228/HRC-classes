...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		try {
			...
			Connection con = advancedSearchData.getConnection();
...
//			String page = request.getParameter("page");
			...
			String sql_statement = "SELECT * FROM winter_internship_updated WHERE cust_number LIKE '%" + customerNumber +"%'" + " OR buisness_year LIKE '%"+buisnessYear+"%' OR  doc_id LIKE '%" +documentId+"%' OR invoice_id LIKE '%" + invoiceId+"%' AND is_deleted=0;";
